...
> 面向工程、五金、家具、卫浴等零售行业的专业报价工具，帮助商家快速生成专业报价单，提升成交效率

## 📱 项目简介

一款支持多行业的报价表生成小程序，提供商品管理、客户管理、快速报价、报价单分享等核心功能。支持免费版和付费会员两种模式。
...
> 详细的商业模式设计请查看：[docs/business-model.md](docs/business-model.md)
